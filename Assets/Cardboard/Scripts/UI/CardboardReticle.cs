...
//	UnityEvent OTD; 
	...
	[System.Serializable]
	public class Myevents : UnityEvent<GameObject>
	{
	}
  ...
  public void OnGazeStay(Camera camera, GameObject targetObject, Vector3 intersectionPosition) {
        ...
        if (targetObject != focusedObj)
			focusedObj = targetObject;
    SetGazeTarget(intersectionPosition);
  }
  ...
  public void OnGazeTriggerStart(Camera camera) 
	{
		...
		if (focusedObj != null && focusedObj.name!="ExploreText")
			myeve.Invoke (focusedObj);
		else
			print ("Target Obj not set");
  	}
